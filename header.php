        ...
        <nav class="navbar navbar-static-top">
              ...
              <div class="container">
                ...
                <div id="navbar" class="navbar-collapse collapse pull-right">
                  ...
                  <ul class="nav navbar-nav">
                    ...
                    <li><a class="is-active has-child" href="http://50.87.248.187/~twooneu9/USHWP/missions/">MISSION</a>
                    <ul class="submenu">
            ...
            <li class="has-child"><a href="#">TAKE ACTION</a>
                    <ul class="submenu">
                         ...
                         <li class="submenu-item"><a href="http://50.87.248.187/~twooneu9/USHWP/donate">Donate </a></li>
                      </ul>
            </li>
                    ...
                    <ul class="submenu">
                      ...
                      <li>
                        <div class="header_donate">
                          ...
                          <button name="submit" class="btn btn-lg btn-secondary">DONATE</button>
                          </form>
                        </div>
                      </li>
            </li> </ul>
